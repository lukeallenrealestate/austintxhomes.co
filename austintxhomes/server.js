...
app.get('/sell-house-78701-austin', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/sell-house-78701-austin.html')));
app.get('/sell-house-78702-austin', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/sell-house-78702-austin.html')));
...
app.get('/1031-exchange-rules-and-deadlines',         (_req, res) => res.sendFile(path.join(__dirname, 'public/site/1031-exchange-rules-and-deadlines.html')));
app.get('/reverse-1031-exchange-austin',              (_req, res) => res.sendFile(path.join(__dirname, 'public/site/reverse-1031-exchange-austin.html')));
...
app.get('/austin-relocation-specialist', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/austin-relocation-specialist.html')));
app.get('/new-construction-specialist-austin-tx', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/new-construction-specialist-austin-tx.html')));
app.get('/new-construction-homes-for-sale-austin-tx', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/new-construction-homes-for-sale-austin-tx.html')));
...
app.get('/ut-austin-out-of-state-parent-guide', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/ut-austin-out-of-state-parent-guide.html')));
app.get('/ut-austin-tuition-savings-calculator', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/ut-austin-tuition-savings-calculator.html')));
...
app.get('/pedernales-river-realtor',          (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-realtor.html')));
app.get('/pedernales-river-homes-for-sale',   (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-homes-for-sale.html')));
app.get('/pedernales-river-waterfront-homes', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-waterfront-homes.html')));
app.get('/pedernales-river-ranches-for-sale', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-ranches-for-sale.html')));
app.get('/pedernales-river-land-for-sale',    (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-land-for-sale.html')));
app.get('/pedernales-river-market-report',    (_req, res) => res.sendFile(path.join(__dirname, 'public/site/pedernales-river-market-report.html')));
app.get('/living-along-pedernales-river',     (_req, res) => res.sendFile(path.join(__dirname, 'public/site/living-along-pedernales-river.html')));
app.get('/sell-pedernales-river-home',        (_req, res) => res.sendFile(path.join(__dirname, 'public/site/sell-pedernales-river-home.html')));
...
app.get('/dripping-springs-homes-for-sale', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/dripping-springs-homes-for-sale.html')));
app.get('/dripping-springs-market-report', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/dripping-springs-market-report.html')));
app.get('/living-in-dripping-springs', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/living-in-dripping-springs.html')));
app.get('/sell-home-dripping-springs', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/sell-home-dripping-springs.html')));
app.get('/dripping-springs-tx-realtor', (_req, res) => res.redirect(301, '/dripping-springs-realtor'));
app.get('/dripping-springs-tx-homes-for-sale', (_req, res) => res.redirect(301, '/dripping-springs-homes-for-sale'));
...
app.get('/best-family-friendly-neighborhoods-austin-good-schools', (_req, res) => res.sendFile(path.join(__dirname, 'public/site/best-family-friendly-neighborhoods-austin-good-schools.html')));
app.get('/single-family-homes-south-lamar-austin-under-600k',     (_req, res) => res.sendFile(path.join(__dirname, 'public/site/single-family-homes-south-lamar-austin-under-600k.html')));
app.get('/commute-time-mueller-to-downtown-austin-tech',          (_req, res) => res.sendFile(path.join(__dirname, 'public/site/commute-time-mueller-to-downtown-austin-tech.html')));
app.get('/central-austin-neighborhoods-vs-round-rock-suburbs',    (_req, res) => res.sendFile(path.join(__dirname, 'public/site/central-austin-neighborhoods-vs-round-rock-suburbs.html')));
app.get('/is-austin-housing-market-crashing-or-normalizing',      (_req, res) => res.sendFile(path.join(__dirname, 'public/site/is-austin-housing-market-crashing-or-normalizing.html')));
app.get('/how-much-house-can-i-afford-in-austin-tx-150k-income',  (_req, res) => res.sendFile(path.join(__dirname, 'public/site/how-much-house-can-i-afford-in-austin-tx-150k-income.html')));
app.get('/austin-property-taxes-explained-travis-county',         (_req, res) => res.sendFile(path.join(__dirname, 'public/site/austin-property-taxes-explained-travis-county.html')));
