...
// Mueller is a developer-named planned community on the site of the former
// Robert Mueller Municipal Airport (closed 1999). Filtering by subdivision
// name is more accurate than ZIP because 78723 includes large adjacent
// non-Mueller areas (Windsor Park, MLK 183, parts of Pecan Springs).
// Mueller's distinctive trait: condo + townhouse dominant (not luxury SFR).
console.log('Loading residential records (Mueller subdivision)...');
const ALL = q(`SELECT * FROM listings WHERE subdivision_name LIKE '%Mueller%' AND property_type = 'Residential' AND property_sub_type IN ('Single Family Residence','Condominium','Townhouse')`);
...
console.log('═══════════════════════════════════════════════════════════════');
console.log('  MUELLER 2026 DEEP MARKET ANALYSIS');
console.log('═══════════════════════════════════════════════════════════════');
console.log();
