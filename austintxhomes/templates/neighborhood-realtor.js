...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-inner { max-width: var(--w); margin: 0 auto; text-align: center; }
    .hero-eyebrow {
...
<script src="/js/nav.js"></script>
  ...
  <section class="hero">
    <div class="hero-inner">
      <p class="hero-eyebrow">${n.name} Austin TX · Realtor</p>
      <h1>Best Realtor in<br><em>${n.name} Austin</em></h1>
      <p class="hero-sub">Luke Allen is the go-to realtor in ${n.name}, Austin TX — 5.0 ★ on Google, TREC licensed #788149, with deep knowledge of every street and price point in ${n.name}.</p>
